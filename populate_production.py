"""
Insert mock data into PRODUCTION Neon database.
...
async def insert_production_data():
    ...
    await conn.execute("""
        INSERT INTO tickets (
            ...
            'resolved', 'low', 'sizing', 'wrong_size', 'wrong_size',
    ...
    print(f"\n✅ Total tickets in PRODUCTION: {count}")
    
    count2 = await conn.fetchval("SELECT COUNT(*) FROM ai_analysis")
    print(f"✅ Total AI analyses in PRODUCTION: {count2}")
    
    await conn.close()
    print("\n🎉 PRODUCTION database populated successfully!")
    print("\n🌐 Your live site should now show data:")
    print("   https://cx-aviora-fecaitvzg-prashanths-projects-626ff807.vercel.app")

if __name__ == "__main__":
    asyncio.run(insert_production_data())
